...
$scripts = @(
    ...
    @{
        Name = "Start Codex"
        Description = "Launch Codex CLI directly with full disk read and folder write access"
        LaunchCodex = $true
        Color = [System.Drawing.Color]::FromArgb(0, 150, 136)  # Teal
    },
    @{
...
$form.Size = New-Object System.Drawing.Size(625, 505)
...
"@
            ...
            Start-Process cmd.exe -ArgumentList "/k", "cd /d `"$selectedDir`" && codex --full-auto --sandbox-permissions=`"disk-full-read-access`""
